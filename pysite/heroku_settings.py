...
#Creating mysterious-lowlands-8173... done, stack is cedar-14
...
#https://mysterious-lowlands-8173.herokuapp.com/ | https://git.heroku.com/mysterious-lowlands-8173.git
#WARNING: Incomplete credentials detected, git may not work with Heroku. Run `heroku login` to update your credentials. See documentation for details: https://devcenter.heroku.com/articles/http-git#authentication
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': 'venv18_2',                      # Or path to database file if using sqlite3.
        #'USER': 'root',                      # Not used with sqlite3.
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/var/www/projects/pysite/templates/django",
)
